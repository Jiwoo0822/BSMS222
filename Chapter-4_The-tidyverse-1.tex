...
\hypersetup{
  pdftitle={Chapter 4\_The tidyverse-1},
  hidelinks,
...
\title{Chapter 4\_The tidyverse-1}
\author{}
\date{\vspace{-2.5em}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# answer{-} DNase, Formaldehyde, Orange }
\end{Highlighting}
\end{Shaded}

\hypertarget{manipulation-data-frames}{%
\subsection{4.3 Manipulation data
frames}\label{manipulation-data-frames}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#x \textless{}{-} murder\_rate}
\CommentTok{\#murders \textless{}{-} mutate(murders, rank({-}x))}
\CommentTok{\#or}
\NormalTok{rate }\OtherTok{\textless{}{-}}\NormalTok{ murders}\SpecialCharTok{$}\NormalTok{total}\SpecialCharTok{/}\NormalTok{murders}\SpecialCharTok{$}\NormalTok{population}\SpecialCharTok{*}\DecValTok{100000}
...
## 1                4.779736  2.8244238   23
## 2                0.710231  2.6751860   27
## 3                6.392017  3.6295273   10
## 4                2.915918  3.1893901   17
## 5               37.253956  3.3741383   14
## 6                5.029196  1.2924531   38
## 7                3.574097  2.7139722   25
## 8                0.897934  4.2319369    6
## 9                0.601723 16.4527532    1
## 10              19.687653  3.3980688   13
## 11               9.920000  3.7903226    9
## 12               1.360301  0.5145920   49
## 13               1.567582  0.7655102   46
## 14              12.830632  2.8369608   22
## 15               6.483802  2.1900730   31
## 16               3.046355  0.6893484   47
## 17               2.853118  2.2081106   30
## 18               4.339367  2.6732010   28
## 19               4.533372  7.7425810    2
## 20               1.328361  0.8280881   44
## 21               5.773552  5.0748655    4
## 22               6.547629  1.8021791   32
## 23               9.883640  4.1786225    7
## 24               5.303925  0.9992600   40
## 25               2.967297  4.0440846    8
## 26               5.988927  5.3598917    3
## 27               0.989415  1.2128379   39
## 28               1.826341  1.7521372   33
## 29               2.700551  3.1104763   19
## 30               1.316470  0.3798036   50
## 31               8.791894  2.7980319   24
## 32               2.059179  3.2537239   15
## 33              19.378102  2.6679599   29
## 34               9.535483  2.9993237   20
## 35               0.672591  0.5947151   48
## 36              11.536504  2.6871225   26
## 37               3.751351  2.9589340   21
## 38               3.831074  0.9396843   42
## 39              12.702379  3.5977513   11
## 40               1.052567  1.5200933   35
## 41               4.625364  4.4753235    5
## 42               0.814180  0.9825837   41
## 43               6.346105  3.4509357   12
## 44              25.145561  3.2013603   16
## 45               2.763885  0.7959810   45
## 46               0.625741  0.3196211   51
## 47               8.001024  3.1246001   18
## 48               6.724540  1.3829942   37
## 49               1.852994  1.4571013   36
## 50               5.686986  1.7056487   34
## 51               0.563626  0.8871131   43
\end{verbatim}
...
## 3     California  CA      West   37253956  1257              37.253956
## 4       Colorado  CO      West    5029196    65               5.029196
## 5    Connecticut  CT Northeast    3574097    97               3.574097
## 6         Hawaii  HI      West    1360301     7               1.360301
## 7          Idaho  ID      West    1567582    12               1.567582
## 8          Maine  ME Northeast    1328361    11               1.328361
## 9  Massachusetts  MA Northeast    6547629   118               6.547629
## 10       Montana  MT      West     989415    12               0.989415
## 11        Nevada  NV      West    2700551    84               2.700551
## 12 New Hampshire  NH Northeast    1316470     5               1.316470
## 13    New Jersey  NJ Northeast    8791894   246               8.791894
## 14    New Mexico  NM      West    2059179    67               2.059179
## 15      New York  NY Northeast   19378102   517              19.378102
## 16        Oregon  OR      West    3831074    36               3.831074
## 17  Pennsylvania  PA Northeast   12702379   457              12.702379
## 18  Rhode Island  RI Northeast    1052567    16               1.052567
## 19          Utah  UT      West    2763885    22               2.763885
## 20       Vermont  VT Northeast     625741     2               0.625741
## 21    Washington  WA      West    6724540    93               6.724540
## 22       Wyoming  WY      West     563626     5               0.563626
##         rate rank
## 1  2.6751860   27
## 2  3.6295273   10
## 3  3.3741383   14
...
\hypertarget{exwecises}{%
\subsection{4.6 Exwecises}\label{exwecises}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{filter}\NormalTok{(murders, region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"Northeast"}\NormalTok{, }\StringTok{"West"}\NormalTok{) }\SpecialCharTok{\&}\NormalTok{ rate}\SpecialCharTok{\textless{}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(state, rate, rank)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{data}\NormalTok{(murders)}
\NormalTok{my\_states }\OtherTok{\textless{}{-}}\NormalTok{ murders }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{ (}\AttributeTok{rate=}\NormalTok{total}\SpecialCharTok{/}\NormalTok{murders}\SpecialCharTok{$}\NormalTok{population}\SpecialCharTok{*}\DecValTok{100000}\NormalTok{, }\AttributeTok{rank=}\FunctionTok{rank}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{rate))}\SpecialCharTok{\%\textgreater{}\%}\FunctionTok{filter}\NormalTok{(region }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"Northeast"}\NormalTok{, }\StringTok{"West"}\NormalTok{) }\SpecialCharTok{\&}\NormalTok{ rate}\SpecialCharTok{\textless{}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{\%\textgreater{}\%}\FunctionTok{select}\NormalTok{(state,rate,rank)}
