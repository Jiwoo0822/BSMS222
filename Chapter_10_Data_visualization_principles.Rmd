---
title: "Chapter_10_Data_visualization_principles"
output:
  html_document:
    df_print: paged
---
# Chapter_10 Data visualization principles
...
## 10.3 Do not dsitort quantities
...
library(pander)
data("murders")
murders %>% mutate(rate = total/population*100000) %>%head() %>% pander
```
