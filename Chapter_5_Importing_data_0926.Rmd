---
title: "Chapter_5_Importing_data_0926"
output:
  html_document:
    df_print: paged
---
...
pander(read_csv("carbon_emissions.csv"))
pander(read_csv(files[3]))
pander(read_csv(files[5]))
pander(read_csv(files[6]))
pander(read_csv(files[7]))
pander(read_csv(files[9]))
```
